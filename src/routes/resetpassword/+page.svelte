    ...
    <div class="card-body">
      ...
      >
        <div class="form-control">
          ...
          {#if form?.data.resetPasswordValidationErrors?.password}
            <small id="passwordError" class="text-red-600 label label-text-alt"
              >{form.data.resetPasswordValidationErrors.password[0]}</small
            >
          {/if}
          ...
          {#if form?.data.resetPasswordValidationErrors?.passwordConfirm}
            <small id="passwordConfirmError" class="text-red-600 label label-text-alt"
              >{form.data.resetPasswordValidationErrors.passwordConfirm[0]}</small
            >
          {/if}
